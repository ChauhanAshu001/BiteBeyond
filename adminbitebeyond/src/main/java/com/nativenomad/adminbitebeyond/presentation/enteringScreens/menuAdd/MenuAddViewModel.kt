...
@HiltViewModel
class MenuAddViewModel@Inject constructor(
    ...
    private val _navigateEvent=MutableSharedFlow<MenuAddNavigationEvent>()
    val navigateEvent=_navigateEvent.asSharedFlow()

    private val _uiState= MutableStateFlow<MenuAddEvent>(MenuAddEvent.Nothing)
    ...
    fun addItem(context: Application=application,
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if (bitmap != null) {
                _uiState.value=MenuAddEvent.Loading
                ...
                if (response.isSuccessful) {
                    ...
                    try{
                        ...
                        _uiState.value=MenuAddEvent.Error
                    }
                } else {
                    _uiState.value = MenuAddEvent.Error
                }
    ...
    fun onEvent(menuAddNavigationEvent:MenuAddNavigationEvent){
        when(menuAddNavigationEvent){
            is MenuAddNavigationEvent.NavigateToHome->{
                viewModelScope.launch{
                    _navigateEvent.emit(MenuAddNavigationEvent.NavigateToHome)
                }
            }
        }
    }
