...
private val Context.datastore: DataStore<Preferences> by preferencesDataStore(name = "ADMIN_USER_SETTINGS")
private object PreferenceKey{
    val APP_ENTRY= booleanPreferencesKey(name="entered_admin_app")
}